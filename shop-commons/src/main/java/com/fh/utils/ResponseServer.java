...
public class ResponseServer {
    ...
    private ResponseServer(Integer code,String msg,Object data,Long size){
        this.code=code;
        this.msg=msg;
        this.size=size;
        this.data=data;
    ...
    public static  ResponseServer success(Object data,Long size){
        return new ResponseServer(ServerEnum.SUCCESS.getCode(),ServerEnum.SUCCESS.getMsg(),data,size);
    }
     ...
     * 返回带jwt字符串的登录返回码
     */
    public static ResponseServer loginSuccess(Object data){
        return new ResponseServer(ServerEnum.LOGIN_SUCCESS.getCode(),ServerEnum.LOGIN_SUCCESS.getMsg(),data);
    }
